...
\definecolor{magenta}{HTML}{C90D35}
\usepackage{csquotes}
...
\usepackage{acronym}
%% Document settings
\title{Integrated Design of a Controller and Compliant Power Supply for USB Power Delivery}
\subCode{MVE491P}
...
%% Internal Guide%%%%
\guideNameA{Prof. S Praveen}
\guideDesignationA{Assistant Professor}
\guideDeptA{Dept. of ECE}
\guideOrgA{RV College of Engineering}

%%%External Guide%%%%
\guideNameB{Ms. Evelyn Veena Lobo}
\guideDesignationB{Manager}
\guideDeptB{Applications Engg.}
\guideOrgB{GlobalFoundries}
...
\projectMemberA{Dr. Sujatha Badiger}
...
\QRurl{https://drive.google.com/drive/folders/1K82K_1KtMTGeCb2IwAQwueHWEoI2IVGE?usp=sharing}
